...
P08_SaveData
writetable(csvData, 'Satellite_Australia_Simulation_Log_starlink_uplink.csv');
fprintf('CSV saved with %d valid samples: Satellite_Australia_Simulation_Log_starlink_uplink.csv\n', validSamples);
%% Play Simulation
...
save('SatelliteSimulationState_starlink_uplink.mat', 'sc', 'logData', 'leoSats', 'leoGsList', 'leoRx');
fprintf('Simulation state saved to SatelliteSimulationState_starlink_uplink.mat\n');
%% Load Simulation State
fprintf('\nLoading simulation scenario data...\n');
load('SatelliteSimulationState_starlink_uplink.mat');
v = satelliteScenarioViewer(sc);
v.ShowDetails = true;
play(sc, 'PlaybackSpeedMultiplier', 100);
